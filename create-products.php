...
$sql="INSERT INTO post(item,description,price,image) VALUES(:pitem,:pdescription,:pprice,:pimage)";
$query = $dbh->prepare($sql);
$query->bindParam(':pname',$pname,PDO::PARAM_STR);
$query->bindParam(':pdescription',$ptype,PDO::PARAM_STR);
...
<html>
<head>
<title>MUNTI | Admin Package Creation</title>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Product Location</label>
									<div class="col-sm-8">
