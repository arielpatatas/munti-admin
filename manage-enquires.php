...
<html>
<head>
<title>Explore PH | Admin manage Bookings</title>
...
{				?>		
						  <tr>
							<td width="120"><?php echo htmlentities($result->id);?></td>
							<td width="50"><?php echo htmlentities($result->name);?></td>
								<td width="50"><?php echo htmlentities($result->mobile);?></td>
								<td width="50"><?php echo htmlentities($result->email);?></td>
							<td width="200"><?php echo htmlentities($result->issues);?></a></td>
							<td width="400"><?php echo htmlentities($result->description);?></td>
							<td width="50"><?php echo htmlentities($result->date);?></td>
							<td width="50"><?php echo htmlentities($result->action);?></td>
