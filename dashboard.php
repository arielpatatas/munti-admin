...
<html>
<head>
<title>MUNTI | Admin Dashboard</title>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Products</h3>
										<?php $sql1 = "SELECT space_id from workspace";
...
$.ajax({
  method: "GET",
  url: "http://localhost/explore%20ph/travel/admin/chart2.php",
  success: 
  function(response){
	  data = response;
    ...
    type: 'bar',
    data: {
      labels: ["Baguio Trip", "Banaue Trip", "Bohol Trip", "Boracay Trip", "Camiguin Trip","Cebu Trip"],
      datasets: [
        {
          label: "Total",
          backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850","#3e81cd"],
          data: data
        }
      ]
    },
    options: {
      ...
      title: {
        display: true,
        text: 'Graphical Representation of Sales in MUNTI'
      }
    }
});
  }
